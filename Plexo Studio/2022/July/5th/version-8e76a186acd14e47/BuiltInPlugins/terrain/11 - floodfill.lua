...
game:GetService("ContentProvider"):Preload("http://www.plexxo.xyz/asset/?id=82741829")
...
function MouseHighlighter.Create(mouseUse)
	...
	imageLabel.Image = "http://www.plexxo.xyz/asset/?id=82741829"
...
function LoadProgressBar(text)
	...
	while spinnerNum <= 8 do
	   ...
	   spinnerImage.Image = "http://www.plexxo.xyz/Asset/?id=45880710"
		...
		while processing do
			...
			while pos < 8 do
				if pos == spinPos or pos == ((spinPos+1)%8) then
					spinnerIcons[pos+1].Image = "http://www.plexxo.xyz/Asset/?id=45880668"
				else
					spinnerIcons[pos+1].Image = "http://www.plexxo.xyz/Asset/?id=45880710"
				end
